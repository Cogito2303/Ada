        ...
        <form 
            ...
            <!-- Residence -->
             <div class="mt-4">
                ...
                <select id="residence" class="block mt-1 w-full rounded-md" x-model="residence" required>
            ...
            <div class="mt-4">
                ...
                <select id="neighborhood" class="block mt-1 w-full rounded-md" x-model="neighborhood" required>
